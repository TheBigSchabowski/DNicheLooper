...
/**
 * Loads the bundled acoustic drum kit (see assets/drums/ATTRIBUTION.txt)
...
object DrumKitLoader {
    ...
    fun ensureLoaded(context: Context) {
        ...
        val result = runCatching {
            AudioEngine.setDrumSamples(
                kick = readRawFloats(context, "drums/kick.raw"),
                snare = readRawFloats(context, "drums/snare.raw"),
                hat = readRawFloats(context, "drums/hat.raw"),
    ...
    private fun readRawFloats(context: Context, path: String): FloatArray {
